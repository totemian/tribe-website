...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#CFFF5E]/5 to-white" />

      <motion.div
        className="absolute top-20 left-10 w-24 h-24 rounded-full bg-[#CFFF5E]/20 blur-3xl"
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-full bg-[#CFFF5E]/10 blur-3xl"
        animate={{
          x: [0, -40, 0],
          y: [0, 30, 0],
          scale: [1, 1.2, 1],
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                Connect with Vancouver&apos;s local businesses. Earn rewards. Build community.
              </motion.p>
            </div>
            ...
            >
              <motion.a
                ...
                className="bg-[#CFFF5E] text-[#121212] px-6 py-3 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 group relative overflow-hidden"
            ...
            >
              {["Scan & Earn Points", "Discover Local Spots", "Boost Reviews", "Build Community"].map((benefit, i) => (
                <motion.div
                  key={benefit}
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              <motion.div
                className="absolute inset-0 bg-[#CFFF5E]/30 blur-[80px] rounded-full scale-75"
                animate={{
