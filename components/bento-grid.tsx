...
const features = [
  {
    ...
    description: "Growing community of rewards seekers",
    accent: "#CFFF5E",
  },
  {
    icon: Flame,
    title: "500+",
    subtitle: "Partner Nodes",
    description: "Local businesses joined the ecosystem",
    accent: "#CFFF5E",
  },
  {
    icon: Brain,
    ...
    description: "Average boost for partner businesses",
    accent: "#CFFF5E",
  },
  {
    icon: Sparkles,
    ...
    description: "Real value returned to members",
    accent: "#CFFF5E",
  },
]
...
export function BentoGrid() {
  ...
  return (
    <section id="ecosystem" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#CFFF5E] text-[10px] tracking-[0.3em] uppercase"
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#CFFF5E] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
